			    ...
			    <div class="modal-body">
		        	...
		        	<ul class="list-group list-group-flush" v-if="areRatesVisible == 1" v-cloak style="margin-top: 24px;">
						...
						<li class="list-group-item" v-for="service in services" style="padding: 0">
							<p class='subtitle'>Package reference: '<b>{{ service.package_reference }}</b>', 
																	weight: <b>{{ service.package_weight }}kg</b></p>
	
							<ul class="list-group list-group-flush">
								<li class="list-group-item" v-for="rate in service.rates" style="padding: 0">
									<small>{{ rate.service_name }}: ${{ rate.charge }}</small>
								</li>
							</ul>
