	  	...
	  	<div class="modal-dialog" role="document">
		    <div class="modal-content">
			    ...
			    <div class="modal-body">
					...
					<div v-if="errors.length == 0" v-for="(pin, index) in pins">
...
<!-- 							<button type="button" class="btn btn-outline-info btn-sm btn-show-pdf" 
										onclick="$(this).parent().find('div.pdf-label').toggle();">Show / Hide label</button> -->

							<div class="pdf-label" v-bind:id="'shipment-labels-' + index">
